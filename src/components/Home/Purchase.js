                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="mt-6 w-full">
                            ...
                            <div className="mt-6">
                                <input type='submit'
                                    ...
                                    className="w-full cursor-pointer px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600" />
