        ...
        <div className='py-6 md:pb-8'>
            <div class="drawer drawer-mobile">
                ...
                <div class="drawer-content flex flex-col items-center">
                    {/* <!-- Page content here --> */}
                    <h2 className="text-4xl text-primary text-center font-bold py-4">Dashboard</h2>
                ...
                <div class="drawer-side">
                    ...
                    <div class="flex flex-col w-64 h-screen py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600 overflow-hidden">
                        ...
                        <div class="flex flex-col justify-between flex-1 mt-6">
                            <nav>
                                ...
                                <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                                    ...
                                    <span class="mx-4 font-medium">Prifile</span>
                                </a>
