    ...
    return (
        <div className='w-full flex flex-col gap-3'>
            ...
            <div className='w-full'>
                <div class="flex max-w-4xl w-full mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
                    <div class="w-1/3 bg-cover" style={{ backgrounImage: "url('https://images.unsplash.com/photo-1494726161322-5360d4d0eeae?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=334&q=80')" }}></div>
