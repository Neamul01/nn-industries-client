...
const Signup = () => {
    return (
        <div className='py-6 md:py-12'>
            <div class="w-full max-w-lg p-14 m-auto bg-white rounded-lg shadow-xl dark:bg-gray-800">
                <h1 class="text-3xl font-semibold text-center text-gray-700 dark:text-white">Sign Up</h1>
                ...
                <form class="mt-6">
                    ...
                    <div class="mt-4">
                        <div class="flex items-center justify-between">
                            <label for="confirmPassword" class="block text-sm text-gray-800 dark:text-gray-200">Confirm Password</label>
                        </div>
                ...
                <p class="mt-2 text-xs font-light text-center text-gray-400"> Already have an account? <Link to={'/login'}
